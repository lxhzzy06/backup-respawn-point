...
world.beforeEvents.playerInteractWithBlock.subscribe((e) => {
  ...
  if (player.MainHandSolt.getItem() === undefined && player.isSneaking && block.typeId === MinecraftBlockTypes.Bed && player.getSpawnPoint()) {
    e.cancel = true;
...
world.afterEvents.playerSpawn.subscribe(({ player, initialSpawn }) => {
  if (initialSpawn) {
    player.MainHandSolt = (player.getComponent(EntityEquippableComponent.componentId) as EntityEquippableComponent).getEquipmentSlot(
